...
model_list = [
        ...
        # ACER(MlpPolicy, env, verbose=1, tensorboard_log="../results/tensorboard_logs/ACER/"),   # don't support continuous actions yet
...
algo_list = [
        "A2C",
        # "ACER",  # don't support continuous actions yet
        "ACKTR",
        # "DDPG",
        # "DDQN",
        # "DQN",
